...
function Dashboard() {
  ...
  // Fetch saved itineraries from backend on mount
  useEffect(() => {
  ...
  // Fetch city images from Unsplash for each itinerary city
  useEffect(() => {
  ...
  // Handle itinerary deletion with confirmation and update UI
  ...
  // Filter itineraries based on search input (case-insensitive)
  ...
  return (
    <div className="container mt-5 py-5 mb-5">
      ...
      {filteredItineraries.length === 0 ? (
        ...
        <div className="row">
          {/* Render each itinerary card with animation */}
          {filteredItineraries.map((itin, index) => (
            ...
            >
              <div className="card border-0 shadow-lg rounded-4 overflow-hidden h-100">
                ...
                {/* List of places in the itinerary */}
